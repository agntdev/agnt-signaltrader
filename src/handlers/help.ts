...
const HELP =
  "Use the menu to manage monitored channels, approved posters, parsing rules, and execution history.\n\n" +
  "Use /history for a quick execution log.\n\n" +
  "Send signals as: EURUSD BUY 0.10 SL 1.0800 TP 1.0900.";
